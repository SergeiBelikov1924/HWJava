...
public class MainNotebook {
    ...
    public static void main(String[] args) {
        Notebook notebook1 = new Notebook("Lenovo", 4, 1000, "Windows 7", "black");
        Notebook notebook2 = new Notebook("HP", 16, 10000, "Windows XP", "grey");
        Notebook notebook3 = new Notebook("MacPro", 8, 1000, "macOS Catalina", "white");
        Notebook notebook4 = new Notebook("Asus", 32, 100000, "Windows 10", "black");
        Notebook notebook5 = new Notebook("Huawey", 2, 100, "Windows 8", "silwer");
        Notebook notebook6 = new Notebook("MacPro 2023", 64, 1000000, "macOS Sonoma", "gold");
    ...
    public static void filter(Set<Notebook> notebooks) {
        ...
        while (endOfFiltr == true) {
            switch (command) {
                case ("1"):
                    System.out.println("Вы можете ввести желаемый объем оперативной памяти и вам будут представлены варианты ноутбуков с таким объёмом и выше.");
                    ...
                    break;
                case ("2"):
                    System.out.println("Вы можете ввести желаемый объем жесткого диска и вам будут представлены варианты ноутбуков с таким объёмом и выше.");
                    ...
                    break;
                case ("3"):
                    System.out.println("Вы можете ввести название желаемой операционной системы.");
                    ...
                    break;
                case ("4"):
                    System.out.println("Вы можете ввести название желаемого цвета.");
